<?php
/**
 * shaneprovost functions and definitions
 *
...
function sp_setup() {
	 ...
	 * If you're building a theme based on shaneprovost, use a find and replace
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'sp' ),
	) );
...
function sp_scripts() {
	...
	wp_enqueue_script( 'sp-header-js', get_template_directory_uri() . '/js/header.min.js', '', '', false);
	wp_enqueue_script( 'sp-footer-js', get_template_directory_uri() . '/js/footer.min.js', '', '', true);
